...
```console
python3 -m pytest -q tests/test_nuisance_conditioning.py tests/test_nuisance_runner.py
```

Run the mechanistic smoke and frozen development screen:

```console
python3 -m experiments.nuisance_conditioned_distance.runner --stage smoke --output experiments/nuisance_conditioned_distance/results/smoke
python3 -m experiments.nuisance_conditioned_distance.runner --stage screen --output experiments/nuisance_conditioned_distance/results/screen
```
...
```console
python3 -m experiments.nuisance_conditioned_distance.runner --stage full --output experiments/nuisance_conditioned_distance/results/full_synthetic
python3 -m experiments.nuisance_conditioned_distance.food101 --output experiments/nuisance_conditioned_distance/results/food101
